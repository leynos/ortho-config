//! Normalizes displayed default values coming from bridge IR.
//!
//! Rust types render default values such as enum variants and paths in their
//! debug or display form. This module rewrites those displays for the
//! agent-context surface: `"crate::module"`-style path segments become
//! `crate::module` (with surrounding whitespace trimmed), while the literal
//! contents of quoted strings, character literals, and raw strings are
//! preserved verbatim.

/// Normalizes displayed Rust paths while preserving all literal contents.
#[must_use]
pub fn normalize_default_display(display: &str) -> String {
