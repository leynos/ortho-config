# Archived v0.8.0 roadmap

This archive preserves the completed OrthoConfig roadmap phases, steps, and
tasks that led up to the v0.8.0 planning boundary. The active roadmap continues
