...
pub struct AddUserArgs {
    ...
    pub username: String,
    #[arg(long)]
    pub admin: bool, // Using bool makes it a flag
}
...
#[clap_dispatch(fn execute(self, db_connection_url: &str) -> Result<(), String>)]
...
```text
    ...
    items in category 'electronics', All: false
...
environment variables, or configuration files predictably. The
