...
| `scripts/`              | Python and shell-adjacent maintenance scripts, including the shared spelling-policy cache, renderer, and `generate_typos_config.py` entrypoint. Focused script tests live under `scripts/tests/`.                                                                                          |
