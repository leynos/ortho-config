...
| `docs/`                 | Long-lived project documentation. Use `docs/contents.md` as the index, `docs/users-guide.md` for consumers, `docs/developers-guide.md` for maintainers, `docs/design.md` and focused design documents for architecture, and `docs/roadmap.md` for active delivery planning. |
...
| `scripts/`              | Python and shell-adjacent maintenance scripts. Script tests live under `scripts/tests/` and run through the workspace test target.                                                                                                                                          |
